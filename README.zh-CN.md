...
VNaive Admin 是一个免费开源的中后台模版。使用了最新的`vue3 vite3 TypeScript`等主流技术开发，开箱即用的中后台前端解决方案，也可用于学习参考。
...
- [VNaive-admin](https://www.mmxxn.cn/) - 完整版中文站点

测试账号: VNaive/123456

<p align="center">
    <img alt="VNaive Logo" width="100%" src="">
    <img alt="VNaive Logo" width="100%" src="">
    <img alt="VNaive Logo" width="100%" src="">
</p>
...
`VNaive-Admin` 是完全开源免费的项目，在帮助开发者更方便地进行中大型管理系统开发，同时也提供 QQ 交流群使用问题欢迎在群内提问。
